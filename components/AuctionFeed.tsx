...
/**
 * Live-auction grid: fetches live lots (safe columns only, never
 * `reserve_cents`) and renders cards linking to `/subastas/[id]`. Shared by
 * `/` (home) and `/subastas` so both stay in sync.
 */
